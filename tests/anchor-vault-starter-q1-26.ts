...
import  { AnchorVaultStarterQ126 } from "../target/types/anchor_vault_starter_q1_26";
import { expect } from "chai";
describe("anchor-vault-starter-q1-26", () => {
  // Configure the client to use the local cluster.
  const provider = anchor.AnchorProvider.env();
  anchor.setProvider(provider);

  const program = anchor.workspace.AnchorVaultStarterQ126 as Program<AnchorVaultStarterQ126>;
